defmodule NoteAppWeb.CoreComponents do
  @moduledoc """
...
##   end
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(NoteAppWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(NoteAppWeb.Gettext, "errors", msg, opts)
    end
  end
